...
const routes = [
  ...
  "DELETE /v1/organizations/:organizationId/worlds/:worldId/auth/tokens/:tokenUid",
  ...
  "DELETE /v1/organizations/:organizationId/platform-tokens/:tokenUid",
  "GET /v1/organizations/:organizationId/usage",
  "GET /v1/organizations/:organizationId/worlds/:worldId/usage",
